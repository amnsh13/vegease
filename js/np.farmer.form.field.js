...
$(document).ready(function(e){
  //variables
  var html = ' <p><div><label for="crop" class="crop">फसलको नाम र फसलको समय</label> <br> <input type="text" name="crop[]" id="childcrop" style="width:61%;">&emsp; <input type="date" name="harvest[]" id="childharvest"> <a  id="remove">हटाउनुहोस्</a></div></p>';
  var maxrows = 5;
  var x = 1;
